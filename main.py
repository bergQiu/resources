...
if __name__ == "__main__":
    p = "JEz96ep4+19m/V3wWN4h8eoL12/R9aHyxmUlO5wbUEe2FaGmEqc14h1PliKu7KRLoPkF9Gnj8kfWraSPj6CeKzH+a4/HjtGvsdfZiQDIKXmMpD/AfVNi47MIKTRNV2OOIBvBWXvBp+Te3LUVTUdu8ZJNklV2+Q07T/dcRrDDNSSaMMrdpvMGOIt2sHQJQ2YB"
    k = ""
    p_ = "TsbMStG/7vrZZKBJSi5SBslXFtjdUqsUkrChKtZJvHoeb9NnejPbf5mw1PBmr/Nxxuz/k4PUNvh7ORkXEVxrYY7/D9EGlDRXt7xQUQ7uqk31z5/ftJkyxjMelMri3547irw9rVaq9bevXdaP25KtHzrYlKoQaOlpSY3GcmxkJK3Fxk00wnP6zLlcTNnLA2/D"
    k_ = ""

    print("here")
    print(get_params((2)))
    print(get_encsekey())
    # content = get_json(url,get_params(1),get_encsekey())
    content = get_json(url, p_,k)
    # print (content.text())
